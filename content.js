...
window.addEventListener('message', event => {
  ...
  // Recarregar aba do ServiceNow se a sessão do dashboard expirar
  if (type === 'EMS_DASHBOARD_SESSION_EXPIRED') {
    chrome.runtime.sendMessage({ type: 'RELOAD_SERVICE_NOW_TAB' });
  }
});
